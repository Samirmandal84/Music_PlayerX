...
import com.samirpriyu.musicplayerx.databinding.MusicViewBinding
...
class MusicAdapter(private val context: Context, private val musicList: ArrayList<Music>) : RecyclerView.Adapter<MusicAdapter.MyHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        return MyHolder(binding = MusicViewBinding.inflate(LayoutInflater.from(context), parent, false))
    }
